		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
					...
					<input type="password" class="registration-input--large" name="onlinework-password" placeholder="Да, мой пароль:">
						
					<div class="registration-input--radio">						
						<input type="radio" id="radio01" name="onlinework-radio" value="forget-pass"/>
	  					<label for="radio01">Да, но я забыл свой пароль<span></span></label>
	  					<input type="radio" id="radio02" name="onlinework-radio" value="new-user"/>
	  					<label for="radio02">Нет, я новый пользователь<span></span></label>
  					</div>
  					<input type="button"  name="onlinework-button" class="registration-input--button registerOnline" value="Продолжить">
				</div>
			</div>			
		</div>
	</section>
